...
`![Music playlist inventory](doc/03-component-interfaces/Untitled Notebook (5).pdf)`
If you do not see the image you can also just go to the path:
`doc/03-component-interfaces/Untitled Notebook (5).pdf`
